(window.webpackJsonp = window.webpackJsonp || []).push([
    [21], {
        "./node_modules/hammerjs/hammer.js": function (t, e, n) {
            var i;
            ...
            ! function (s, o, a, u) {
                    ...
                    n.isFirst = !!s, n.isFinal = !!o, s && (t.session = {}), n.eventType = e,
                        function (t, e) {
                            ...
                            var s = n.firstInput,
                                ...
                                u = e.center = j(i);
                            e.timeStamp = v(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = Z(a, u), e.distance = G(a, u),
                                function (t, e) {
                                    var n = e.center,
                                        i = t.offsetDelta || {},
                                        r = t.prevDelta || {},
                                ...
                                }(n, e), e.offsetDirection = V(e.deltaX, e.deltaY);
                            var h = U(e.deltaTime, e.deltaX, e.deltaY);
                            e.overallVelocityX = h.x, e.overallVelocityY = h.y, e.overallVelocity = f(h.x) > f(h.y) ? h.x : h.y, e.scale = o ? (c = o.pointers, l = i, G(l[0], l[1], k) / G(c[0], c[1], k)) : 1, e.rotation = o ? function (t, e) {
                                    return Z(e[1], e[0], k) + Z(t[1], t[0], k)
                ...
                function et() {
                    this.evEl = Q, this.evWin = tt, q.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
                }
                s.MSPointerEvent && !s.PointerEvent && (Q = "MSPointerDown", tt = "MSPointerMove MSPointerUp MSPointerCancel"), I(et, q, {
                    handler: function (t) {
                        var e = this.store,
                            n = !1,
                            i = t.type.toLowerCase().replace("ms", ""),
                            r = $[i],
                            s = K[t.pointerType] || t.pointerType,
                            o = "touch" == s,
                ...
                function ut() {
                    ...
                    this.touch = new ot(this.manager, t), this.mouse = new J(this.manager, t), this.primaryTouch = null, this.lastTouches = []
                }
                ...
                dt.prototype = {
                    set: function (t) {
                        "compute" == t && (t = this.compute()), ft && this.manager.element.style && vt[t] && (this.manager.element.style[pt] = t), this.actions = t.toLowerCase().trim()
                    },
                    update: function () {
                    ...
                    preventDefaults: function (t) {
                        ...
                        if (this.manager.session.prevented) e.preventDefault();
                            ...
                            var i = this.actions,
                                r = P(i, "none") && !vt.none,
                                s = P(i, "pan-y") && !vt["pan-y"],
                                o = P(i, "pan-x") && !vt["pan-x"];
                            if (r) {
                ...
                function mt(t) {
                    this.options = h({}, this.defaults, t || {}), this.id = z++, this.manager = null, this.options.enable = S(this.options.enable, !0), this.state = 1, this.simultaneous = {}, this.requireFail = []
                }
                ...
                function wt(t, e) {
                    return (e = e || {}).recognizers = S(e.recognizers, wt.defaults.preset), new Pt(t, e)
                }
                mt.prototype = {
                    defaults: {},
                    set: function (t) {
                    ...
                    dropRecognizeWith: function (t) {
                        return m(t, "dropRecognizeWith", this) || (t = Tt(t, this), delete this.simultaneous[t.id]), this
                    },
                    ...
                    emit: function (t) {
                        ...
                        n < 8 && i(e.options.event + gt(n)), i(e.options.event), t.additionalEvent && i(t.additionalEvent), n >= 8 && i(e.options.event + gt(n))
                    },
                    tryEmit: function (t) {
                    ...
                    attrTest: function (t) {
                        return Et.prototype.attrTest.call(this, t) && (2 & this.state || !(2 & this.state) && this.directionTest(t))
                    },
                    emit: function (t) {
                ...
                function Pt(t, e) {
                    var n;
                    this.options = h({}, wt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((n = this).options.inputClass || (Y ? et : F ? ot : X ? ut : J))(n, L), this.touchAction = new dt(this, this.options.touchAction), xt(this, !0), g(this.options.recognizers, (function (t) {
                ...
                Pt.prototype = {
                    ...
                    bindFn: b,
                    prefixed: M
                }), (void 0 !== s ? s : "undefined" != typeof self ? self : {}).Hammer = wt, void 0 === (i = function () {
                    return wt
