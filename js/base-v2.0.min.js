(function (s) {
        ...
        $("body").on("click", s, function () {
            ...
            if (e.stop().fadeIn(), n) {
                function i(i) {
                    $.each(i, function (i, t) {
                        var n = t[2],
                            o = s.find(t[0]).length > 0 ? s.find(t[0]) : s;
                        "text" != n && n || e.find(t[1]).text(o.text()), "img" == n && e.find(t[1]).attr({
                            src: o.attr("src")
                        }), "attr" == n && (console.log(t[3], o), e.find(t[1]).html(o.attr(t[3]))), "html" == n && e.find(t[1]).html(o.html())
                    })
                }
                i(n)
            }
        ...
        var o = {
            ...
            close: function () {
                n.stop().fadeOut(function () {
                    n.find(".ys_videom_video").remove(), n.find(".ys_videom_iframebox").stop().hide().find("iframe").remove(), k.show()
                })
            },
            show: function () {
                k.hide(), n.stop().fadeIn()
            }
        };
    ...
    function g(s) {
        ...
        i.each(function (s, i) {
            var t = $(i),
                n = t.get(0).slick.$slides;
            t.addClass("ys_slick_anmt"), t.on("beforeChange", function (s, i, n, e) {
                $(i.$slides[n]).addClass("ys_slick_prev"), $(i.$slides[e]).addClass("ys_slick_active");
                var o = i.$slides.length - 1;
                n > e && n == o && 0 == e ? t.addClass("nexting") : n < e && 0 == n && e == o ? t.addClass("preving") : n < e ? t.addClass("nexting") : t.addClass("preving")
            }), t.on("afterChange", function (s, i, e) {
                t.removeClass("preving nexting"), n.removeClass("ys_slick_prev ys_slick_active")
            })
        })
    }
    ...
    b.scrollbar = k, b.goTop = i, b.isFixed = t, b.banVideo = n, b.select = e, b.modal = o, b.videomodal = a, b.mCustomScrollbarInit = l, b.numRoll = c, b.shareInit = r, b.phNavInit = d, b.animateCss = h, b.checkViewport = f, b.reloadCss = _, b.stopSlick = p, b.yxtop = v, b.isIE = u, b.concatHref = y, b.slickAnmt = g, $.fn.slickAuto = m, s.ys = b
})(window);